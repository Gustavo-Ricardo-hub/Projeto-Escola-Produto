...
<body>
  ...
  <div class="container">
    <form name="cliente" method="POST" action="">
      <label for="txtnome">Informe o Cursos:</label>
      ...
      <?php 
        ...
        if(isset($btnenviar))
        {
            ...
            foreach ($pro_bd as $pro_mostrar) {
                echo "<b>Código do Cursos: $pro_mostrar[0]</b>";
                echo "<b>Nome do Cursos: $pro_mostrar[1]</b>";
                echo "<b>Código da Disciplina 1: $pro_mostrar[2]</b>";
                echo "<b>Código da Disciplina 2: $pro_mostrar[3]</b>";
                echo "<b>Código da Disciplina 3: $pro_mostrar[4]</b><br>";
            }    
            if(isset($btnlimpar)) {
              echo "";
