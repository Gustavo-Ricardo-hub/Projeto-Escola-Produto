...
<body>
  <div class="container">
    ...
    <form name="produto" method="POST" action="">
      <div class="form-box">
        <label for="txtid">Informe o ID do Produto</label>
        <input type="text" name="txtid" id="txtid" maxlength="5" placeholder="ID do Produto">
      ...
      <?php
        ...
        if (isset($btnenviar)) {
            ...
            foreach ($pro_bd as $pro_mostrar) {
                echo "<b>ID: $pro_mostrar[0]</b><br>";
                echo "<b>Nome: $pro_mostrar[1]</b><br>";
                echo "<b>Estoque: $pro_mostrar[2]</b><br><br>";
            }
